...
const int timingBudget = 20;

  front.setMeasurementTimingBudgetMicroSeconds(timingBudget);
right45.setMeasurementTimingBudgetMicroSeconds(timingBudget);
frontRight.setMeasurementTimingBudgetMicroSeconds(timingBudget);
left45.setMeasurementTimingBudgetMicroSeconds(timingBudget);
frontLeft.setMeasurementTimingBudgetMicroSeconds(timingBudget);
backRight.setMeasurementTimingBudgetMicroSeconds(timingBudget);
backLeft.setMeasurementTimingBudgetMicroSeconds(timingBudget);
back.setMeasurementTimingBudgetMicroSeconds(timingBudget);
