 ...
 */
 ...
 //This file has been modified to change the address of the LF lunas away from the default 0x10 (16) to the value specified by the tfAddr Variable
...
int16_t  tfAddr = 0x59;    // default I2C address
...
void setup()
{
   ...
   // tfAddr=65;
    tflI2C.Set_I2C_Addr(tfAddr, 0x64);
  delay(1000);
